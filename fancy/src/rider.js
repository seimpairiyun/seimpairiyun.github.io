...
class City extends THREE.Group {
  constructor() {
    super();
    _initBuilding.add(this);

    for (let z = 0; z < 200; z += 20) {
      for (let x = 70; x >= 10; x -= 20) {
        _classPrivateMethodGet(this, _initBuilding, _initBuilding2).call(
          this,
          x,
          z
        );
...
var _getRandomBuilding = function _getRandomBuilding() {
...
var _initBuilding2 = function _initBuilding2(x, z) {
  const building = _classStaticPrivateMethodGet(
    City,
    City,
    _getRandomBuilding
  ).call(City);
...
var _savedObjects = new WeakMap();
var _initObjects = new WeakSet();
var _initLights = new WeakSet();

class SandboxWorld extends THREE.Group {
  constructor() {
    super();
    _initLights.add(this);
    _initObjects.add(this);
    _savedObjects.set(this, { writable: true, value: void 0 });
  ...
  update() {
    ...
    _classPrivateFieldGet(this, _savedObjects).car.position.set(
      0.7 + 0.2 * Math.sin(t),
      0,
      10
    );
...
var _initObjects2 = function _initObjects2() {
  ...
  this.add(mountain);
  this.add(stars);
  _classPrivateFieldSet(this, _savedObjects, { car, city });
};
var _initLights2 = function _initLights2() {
...
var _cameraData = new WeakMap();
var _renderer = new WeakMap();
var _composer = new WeakMap();
var _initScene = new WeakSet();
var _initObjects3 = new WeakSet();
var _initCamera = new WeakSet();
var _initRenderer = new WeakSet();
var _initComposer = new WeakSet();
var _initRenderPass = new WeakSet();
var _initBloomPass = new WeakSet();
var _initShaderPass = new WeakSet();
var _initEventListeners = new WeakSet();
var _onWindowResize = new WeakSet();
var _onMouseMove = new WeakSet();
var _updateEverything = new WeakSet();
var _render = new WeakSet();

class FullScreen3DExample {
  constructor(root) {
    _render.add(this);
    _updateEverything.add(this);
    _onMouseMove.add(this);
    _onWindowResize.add(this);
    _initEventListeners.add(this);
    _initShaderPass.add(this);
    _initBloomPass.add(this);
    _initRenderPass.add(this);
    _initComposer.add(this);
    _initRenderer.add(this);
    _initCamera.add(this);
    _initObjects3.add(this);
    _initScene.add(this);
    _root.set(this, { writable: true, value: void 0 });
    _frameRequestId.set(this, { writable: true, value: void 0 });
    _scene.set(this, { writable: true, value: void 0 });
    _world.set(this, { writable: true, value: void 0 });
    _camera.set(this, { writable: true, value: void 0 });
    _cameraData.set(this, { writable: true, value: void 0 });
    _renderer.set(this, { writable: true, value: void 0 });
    _composer.set(this, { writable: true, value: void 0 });
    _classPrivateFieldSet(this, _root, root);
    _classPrivateFieldGet(this, _root).classList.add(
      FullScreen3DExample.CSS_ROOT
    );
    ...
    _classPrivateFieldGet(this, _root).classList.add(
      FullScreen3DExample.CSS_ROOT_LOADED_VARIANT
    );
...
var _initScene2 = function _initScene2() {
  _classPrivateFieldSet(this, _scene, new THREE.Scene());
};
var _initObjects4 = function _initObjects4() {
...
var _initCamera2 = function _initCamera2() {
  const fov = 45;
  ...
  _classPrivateFieldSet(this, _cameraData, { positionX: 0, positionY: 2 });
};
var _initRenderer2 = function _initRenderer2() {
  const clearColor = COLOR_PALETTE.black;
  const clearColorAlpha = 1;
  _classPrivateFieldSet(
    this,
    _renderer,
    new THREE.WebGLRenderer({ alpha: true, logarithmicDepthBuffer: true })
  );
  _classPrivateFieldGet(this, _renderer).setClearColor(
    clearColor,
    clearColorAlpha
  );
  ...
  if (FLAGS.ENABLE_SHADOWS) {
    ...
    _classPrivateFieldGet(this, _renderer).shadowMap.type =
      THREE.PCFSoftShadowMap;
  }
  _classPrivateFieldGet(this, _root).appendChild(
...
var _initComposer2 = function _initComposer2() {
  ...
  _classPrivateFieldSet(
    this,
    _composer,
    new THREE.EffectComposer(_classPrivateFieldGet(this, _renderer))
  );
...
var _initRenderPass2 = function _initRenderPass2() {
  const renderPass = new THREE.RenderPass(
    _classPrivateFieldGet(this, _scene),
    _classPrivateFieldGet(this, _camera)
  );
  _classPrivateFieldGet(this, _composer).addPass(renderPass);
};
var _initBloomPass2 = function _initBloomPass2() {
  const width = window.innerWidth;
  const height = window.innerHeight;
...
var _initShaderPass2 = function _initShaderPass2() {
...
var _initEventListeners2 = function _initEventListeners2() {
  window.addEventListener(
    "resize",
    _classPrivateMethodGet(this, _onWindowResize, _onWindowResize2).bind(this)
  );
...
var _onWindowResize2 = function _onWindowResize2() {
  const width = window.innerWidth;
  const height = window.innerHeight;
...
var _onMouseMove2 = function _onMouseMove2(e) {
  _classPrivateFieldGet(this, _cameraData).positionX =
    (5 * (window.innerWidth / 2 - e.clientX)) / window.innerWidth;
  _classPrivateFieldGet(this, _cameraData).positionY =
    2 + (0.5 * (window.innerHeight / 2 - e.clientY)) / window.innerHeight;
};
var _updateEverything2 = function _updateEverything2() {
  const t = performance.now() / 1000;
...
var _render2 = function _render2() {
  _classPrivateMethodGet(this, _updateEverything, _updateEverything2).call(
    this
  );
