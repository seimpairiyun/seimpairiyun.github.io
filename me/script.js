...
function showPosition(position) {
  console.log(
    "Location: https://www.google.co.id/maps/place/" +
...
$(document).ready(function () {
  ...
  function Welcome() {
    terminal.append(
      "Welcome to My Terminal — Type <strong style='color:yellow'>help</strong> to view supported commands.\n\n",
    );
  }
  ...
  function about() {
    ...
    if (LOGO != "not found") {
      YourLocation =
        "your location is <a style='color:#16b4ff' href='https://www.google.co.id/maps/place/" +
        LOGO +
        "' target=_blank>there</a>, wasnt it?";
    } else {
      YourLocation = "";
    }
  ...
  function help() {
    terminal.append(
      "<strong style='color:#16b4ff'>Supported commands</strong>" +
        ": about, banner, echo, clear, help, quit.\n",
    );
  }
  ...
  function processCommand() {
    ...
    if (!isValid) {
      if (command == "") {
        ...
        terminal.append(
          "command <strong style='color:red'>" +
            command +
            "</strong> not recognized\n",
        );
      }
    }
